                    ...
                    <div class="card-body">
                        <div class="invoice-header">
                            ...
                            <div class="billed-from">
                                ...
                                <p>215 N2 , ENSAH- Ecole Nationale des Sciences Appliquées Al Hoceima , Al Hoceima <br>
                                    Tel No: 0626414569<br>
                                    Email: ilyassouladdahman@gmail.com</p>
                            </div><!-- billed-from -->
                        </div><!-- invoice-header -->
                        <div class="row mg-t-20">
                            <div class="col-md">
                                ...
                                <div class="billed-to">
                                    <h6>Chalkha Achraf</h6>
                                    <p>4033 Patterson Road, Staten Island, NY 10301<br>
                                        Tel No: 324 445-4544<br>
                                        Email: achrafch@gmail.com</p>
                                </div>
                            </div>
                            <div class="col-md">
