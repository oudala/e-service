        ...
        <div class="col-xl-12">
            <div class="card mg-b-20">
                <div class="card-header pb-0">
                        <a href="Prof/create" class="modal-effect btn btn-sm btn-primary" style="color:white"><i
                        ...
                        <table id="example1" class="table key-buttons text-md-nowrap" data-page-length='50'style="text-align: center">
                            <thead>
                                <tr>
                                    ...
                                    <th class="border-bottom-0">Note Statut</th>
                            ...
                            <tbody>
                                ...
                                @foreach ($profs as $prof)
                                    ...
                                    <tr>
                                        ...
                                        <td><a
                                            href="{{ url('profile') }}/{{ $prof->id }}">{{ $prof->LastName }}</a>
                                        </td>
                                        <td>{{ $prof->email}}</td>
                                        <td>{{ $prof->departement ? $prof->departement->name : 'N/A' }}</td>
                                        <td>
                                            @if ($prof->BoolNote == 1)
                                                <span class="text-success">{{ $prof->NoteStatus }}</span>
                                            @elseif($prof->BoolNote == 2)
                                                <span class="text-warning">{{ $prof->NoteStatus }}</span>
                                            @else
                                                <span class="text-danger">{{ $prof->NoteStatus }}</span>
                                            @endif
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu tx-13">
                                                        <a class="dropdown-item"
                                                            href=" {{ url('edit_prof') }}/{{ $prof->id }}">Edit Prof</a>


                                                        <a class="dropdown-item" href="#" data-prof_id="{{ $prof->id }}"
                                                            data-toggle="modal" data-target="#delete_prof"><i
                                                                class="text-danger fas fa-trash-alt"></i>&nbsp;&nbsp; Delete</a>

                                                        <a class="dropdown-item"
                                                            href="{{ url('Status_show') }}/{{ $prof->id }}"><i
                                                                class=" text-success fasfa-money-bill"></i>&nbsp;&nbsp; Note Status</a>

                                                        <a class="dropdown-item" href="#" data-prof_id="{{ $prof->id }}"
                                                            data-toggle="modal" data-target="#Transfer_prof"><i
                                                                class="text-warning fas fa-exchange-alt"></i>&nbsp;&nbsp; arachive</a>

                                                        <a class="dropdown-item" href="Print_prof/{{ $prof->id }}"><i
