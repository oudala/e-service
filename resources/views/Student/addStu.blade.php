...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">etidient</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/add etudient</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
                        ...
                        <div class="row">
                                ...
                                <select name="Module_id" id="module_id" class="form-control" required>
                                    ...
                                    @foreach ($filieres as $x)
                                        <option value="{{ $x->id }}">{{ $x->name }} {{$x->level}}</option>
                                    @endforeach
                                </select>
                                </div>
                                <div class="col">
                                    <label>password</label>
                                    <input type="text" class="form-control" name="password" placeholder="par default stud1234" >
                                </div>
                                <div class="col">
                                    <label for="inputName" class="control-label">CNE</label>
                                    <input type="text" class="form-control" id="CNE" name="CNE"
                                        title="Enter your CNE number" required>
                                </div>
                        </div><br>
