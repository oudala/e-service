				...
				<div class="app-sidebar__user clearfix">
					<div class="dropdown user-pro-body">
						<div class="">
							...
							@endphp
							<a href="/profile/{{Auth::user()->id}}"><img alt="user-img" class="avatar avatar-xl brround" src="{{URL::asset($image_path)}}"><span class="avatar-status profile-status bg-green"></span></a>
						</div>
						<div class="user-info">
