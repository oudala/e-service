					...
					<div class="main-header-right">
						...
						<div class="nav nav-item  navbar-nav-right ml-auto">
							...
							<div class="dropdown main-profile-menu nav nav-item nav-link">
								@php
									$image_path = 'Attachments/' . Auth::user()->LastName . '/'. Auth::user()->CNI . '.jpg';
								...
								@endphp
								<a class="profile-user d-flex" href="/profile/{{Auth::user()->id}}"><img alt="" src="{{URL::asset($image_path)}}"></a>
								<div class="dropdown-menu">
									<div class="main-header-profile bg-primary p-3">
										<div class="d-flex wd-100p">
											<div class="main-img-user"><a href="/profile/{{ Auth::user()->id }}"><img alt="" src="{{URL::asset($image_path)}}" class=""></a></div>
									...
									<a class="dropdown-item" href="{{ url('/' . $page='page-signin') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i class="bx bx-log-out"></i> Sign Out</a>
