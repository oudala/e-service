                                ...
                                <div class="table-responsive">
                                    <table id="example1" class="table key-buttons text-md-nowrap">
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$x->name}}</td>
                                            <td>{{$x->description}}</td>
                                            <td>{{$x->filiere->name}}</td>
                                            <td>

                                                <a class="modal-effect btn btn-sm btn-info" data-effect="effect-scale"
                                                data-id="{{ $x->id }}" data-name="{{ $x->name }}"
                                                data-description="{{ $x->description }}" data-filiere="{{$x->filiere->name}}" data-toggle="modal" href="#exampleModal2"
                ...
                <div class="modal-content">
                    ...
                    <form id="deleteForm" method="post">
                        ...
                        <div class="modal-body">
                            ...
                            <input class="form-control" name="Module_name" id="Module_name" type="text" readonly>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
...
@section('js')
    ...
    $('#exampleModal2').on('show.bs.modal', function(event) {
        ...
        $('#updateForm').attr('action', '/Module/' + id);
    });
    ...
    $('#modaldemo9').on('show.bs.modal', function(event) {
        ...
        // Set the form action to include the module ID
        $('#deleteForm').attr('action', '/Module/' + Module_id);
    });
    </script>
