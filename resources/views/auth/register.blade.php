            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="CNI" class="col-md-4 col-form-label text-md-end">CNI</label>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="department" id="department" value="1" required>
                                    <label class="form-check-label" for="department">
                                        DMI
                                    </label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="department" id="department" value="2" required>
                                    <label class="form-check-label" for="department">
                                        GCEE
                                    </label>
                                </div>
